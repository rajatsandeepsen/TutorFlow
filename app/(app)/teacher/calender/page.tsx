...
const initialBookedSlots: BookedSlot[] = [
	...
	{
		user: randomUsers[1],
		startTime: withTime(0, 14, 30),
		endTime: withTime(0, 15, 15),
	},
	{
		user: randomUsers[2],
		startTime: withTime(1, 9, 30),
		endTime: withTime(1, 10, 30),
	},
	{
		user: randomUsers[3],
		startTime: withTime(1, 16, 45),
		endTime: withTime(1, 17, 30),
	},
	{
		user: randomUsers[4],
		startTime: withTime(2, 12, 0),
		endTime: withTime(2, 13, 30),
	},
];
